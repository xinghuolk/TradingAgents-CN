...
class TradingAgentsGraph:
    ...
    def __init__(
        ...
        # All providers (native, OAuth subscription, OpenAI-compatible fallback)
        # flow through create_llm_by_provider. Per-role provider/backend_url/
        # api_key enables mixed-mode without a separate branch.
