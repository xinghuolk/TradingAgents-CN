...
| Medium | Documentation links | The harness-controlled current set has zero unresolved links; the harness parser reports 351 unresolved local links across 593 archive Markdown documents. | Older guidance is difficult to navigate and cannot all be structurally gated. | Repair an archive link only when its historical document is promoted or substantively edited; keep the harness-controlled current set at zero. |
